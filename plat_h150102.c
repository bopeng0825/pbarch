...
const int h150101_sdl2_menu_combo[2] = { 10, 11 };
...
static const struct in_default_bind in_h150101_sdl2_defbinds[] = {
    ...
    { H150101_SDL2_BUTTON(15),   IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_LEFT },
    { H150101_SDL2_BUTTON(16),   IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_RIGHT },
    ...
    { H150101_SDL2_BUTTON(0),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_A },
    { H150101_SDL2_BUTTON(1),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_B },
    { H150101_SDL2_BUTTON(3),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_Y },
    { H150101_SDL2_BUTTON(4),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_X },

    { H150101_SDL2_BUTTON(6),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_L },
    { H150101_SDL2_BUTTON(7),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_R },

    { H150101_SDL2_BUTTON(10),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_SELECT },
    { H150101_SDL2_BUTTON(11),    IN_BINDTYPE_PLAYER12, RETRO_DEVICE_ID_JOYPAD_START },

    { H150101_SDL2_BUTTON(31),   IN_BINDTYPE_EMU, EACTION_MENU },
    { 0, 0, 0 }
};
...
const struct menu_keymap in_h150101_sdl2_joy_map[] = {
    ...
    { H150101_SDL2_BUTTON(16),  PBTN_RIGHT },
    ...
    { H150101_SDL2_BUTTON(31),    PBTN_MA2 },
    { H150101_SDL2_BUTTON(31),    PBTN_MA3 },
    { H150101_SDL2_BUTTON(31),    PBTN_L },
    { H150101_SDL2_BUTTON(31),    PBTN_R },
    { H150101_SDL2_BUTTON(31),   PBTN_MENU },
};
